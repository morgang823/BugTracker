...
namespace BugTracker.Services
{
    public class BTTicketService : IBTTicketService
    {
        ...
        public BTTicketService(ApplicationDbContext context, IBTCompanyInfoService companyInfoService, IBTProjectService projectService, UserManager<BTUser> userManager)
        {
            _context = context;
            ...
            else if(string.Compare(role, Roles.Submitter.ToString()) ==0)
            {
                tickets = await _context.Ticket
                      .Include(t => t.Attachments)
                          ...
                          .ThenInclude(p => p.Members)
                          .Include(t => t.Project)
                          .ThenInclude(t => t.ProjectPriority)
        ...
        public async Task<List<Ticket>> GetProjectTicketByStatusAsync(string statusName, int companyId, int projectId)
        {
            List<Ticket> tickets = new();
        ...
        public async Task<List<Ticket>> GetProjectTicketByPriorityAsync(string priorityName, int companyId, int projectId)
        {
            List<Ticket> tickets = new();
        ...
        public async Task<List<Ticket>> GetProjectTicketByTypeAsync(string typeName, int companyId, int projectId)
        {
            List<Ticket> tickets = new();
