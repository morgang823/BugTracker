...
namespace BugTracker.Data
{
    public static class DataUtility
    {
        ...
        public static async Task ManageDataAsync(IHost host)
        {
            ...
            await SeedDefautProjectAsync(dbContextSvc);
        ...
        public static async Task SeedDefaultCompanyAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                var dbCompany = context.Company.Select(c => c.Name).ToList();
                await context.Company.AddRangeAsync(defaultCompany.Where(c => !dbCompany.Contains(c.Name)));
                context.SaveChanges();
        ...
        public static async Task SeedDefaultProjectPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                IList<ProjectPriority> ProjectPriority = new List<ProjectPriority>() {
                ...
                var dbProjectPriority = context.ProjectPriority.Select(c => c.Name).ToList();
                await context.ProjectPriority.AddRangeAsync(ProjectPriority.Where(c => !dbProjectPriority.Contains(c.Name)));
                context.SaveChanges();
        ...
        public static async Task SeedDefautProjectAsync(ApplicationDbContext context)
        {
            ...
            try
            {
                IList<Project> Project = new List<Project>() {
                     ...
                     new Project()
                     {
                         ...
                         Description="A custom designed .Net Core application with postgres database.  The application is a multi tennent application designed to track issue tickets' progress.  Implemented with identity and user roles, Tickets are maintained in Project which are maintained by users in the role of projectmanager.  Each project has a team and team members.",
                         StartDate = new DateTime(2021,1,4),
                         EndDate = new DateTime(2021,1,4).AddMonths(3),
            ...
            {
                Debug.WriteLine("*************  ERROR  *************");
                Debug.WriteLine("Error Seeding Project.");
                Debug.WriteLine(ex.Message);
                Debug.WriteLine("***********************************");
                throw;
            }
        ...
        public static async Task SeedDefaultTicketTypeAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketType> TicketType = new List<TicketType>() {
                ...
                var dbTicketType = context.TicketType.Select(c => c.Name).ToList();
                await context.TicketType.AddRangeAsync(TicketType.Where(c => !dbTicketType.Contains(c.Name)));
                context.SaveChanges();
        ...
        public static async Task SeedDefaultTicketPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketPriority> TicketPriority = new List<TicketPriority>() {
                ...
                var dbTicketPriority = context.TicketPriority.Select(c => c.Name).ToList();
                await context.TicketPriority.AddRangeAsync(TicketPriority.Where(c => !dbTicketPriority.Contains(c.Name)));
                context.SaveChanges();
